...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>CONTACT HERE 👉👉 ----> [ @Lovrincess ] / GROUP HERE 👉👉 @searchmovieshereee !</b>")
...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton("♦️HOW TO DOWNLOAD ♦️", url=f"https://t.me/how_to_download_watch_88")
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                    ...
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              InlineKeyboardButton(
                    "♦️ Jᴏɪɴ Oᴜʀ Bᴀᴄᴋ-Uᴘ Cʜᴀɴɴᴇʟ ♦️", url="https://t.me/princessforever77"
                )
                             ]
                            ]
                        )
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("♦️ Jᴏɪɴ Oᴜʀ Bᴀᴄᴋ-Uᴘ Cʜᴀɴɴᴇʟ ♦️! 😒", show_alert=True)
            return
        ident, file_id = query.data.split("#")
        files_ = await get_file_details(file_id)
        if not files_:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('🔍 ️Search more 🔍', url="https://t.me/searchmovieshereee"),
                    InlineKeyboardButton('♦ ️MAIN CHANNEL ♦️', url="https://t.me/princessforever77")
                ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("♦️ HW TO DOWNLOAD ♦️", url=f"https://t.me/how_to_download_watch_88")
    ])
